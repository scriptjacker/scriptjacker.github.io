...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Home | ScriptJacker | Parth Narula";
            $("#favicon").attr("href", "assets/images/favicon.ico");
        }
        else {
            document.title = "Come Back To ScriptJacker";
...
var typed = new Typed(".typing-text", {
    strings: ["CyberSecurity", "Ethical Hacking", "Bug Hunting", "OWASP", "Reconnaissance", "Scripting", "Linux"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
